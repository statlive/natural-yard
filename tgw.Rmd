...
## making sure the share volume is mounted if working in the office
...
## Some of these coordinates have the final digit of precision
## truncated because we used C-x r k to do a rectangular select in
## emacs. We should probably fix this.
